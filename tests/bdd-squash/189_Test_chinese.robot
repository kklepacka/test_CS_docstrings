...
Test chinese
    ...
    Given testing 𨱏 "${docstrings}[docstring_1]"
...
Test Setup
    ...
    IF    $TEST_189_SETUP_VALUE is not None    Run Keyword    ${TEST_189_SETUP}
...
Test Teardown
    ...
    IF    $TEST_189_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_189_TEARDOWN}
...
Retrieve Docstrings
    ...
    ${docstring_1} =    Set Variable    testing 𨱏
