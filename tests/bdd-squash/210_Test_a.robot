...
Test à
    ...
    Given testing à "${docstrings}[docstring_1]"
...
Test Setup
    ...
    IF    $TEST_210_SETUP_VALUE is not None    Run Keyword    ${TEST_210_SETUP}
...
Test Teardown
    ...
    IF    $TEST_210_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_210_TEARDOWN}
...
Retrieve Docstrings
    ...
    ${docstring_1} =    Set Variable    testing à
