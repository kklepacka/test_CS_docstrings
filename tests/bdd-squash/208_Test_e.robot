...
Test é
    ...
    Given testing é "${docstrings}[docstring_1]"
...
Test Setup
    ...
    IF    $TEST_208_SETUP_VALUE is not None    Run Keyword    ${TEST_208_SETUP}
...
Test Teardown
    ...
    IF    $TEST_208_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_208_TEARDOWN}
...
Retrieve Docstrings
    ...
    ${docstring_1} =    Set Variable    testing é
