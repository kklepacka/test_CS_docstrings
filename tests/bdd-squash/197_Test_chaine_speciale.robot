...
Test chaine speciale
    ...
    Given testing +-_.~@€çé=àûığ "${docstrings}[docstring_1]"
...
Test Setup
    ...
    IF    $TEST_197_SETUP_VALUE is not None    Run Keyword    ${TEST_197_SETUP}
...
Test Teardown
    ...
    IF    $TEST_197_TEARDOWN_VALUE is not None    Run Keyword    ${TEST_197_TEARDOWN}
...
Retrieve Docstrings
    ...
    ${docstring_1} =    Set Variable    testing +-_.~@€çé=àûığ
